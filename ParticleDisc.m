...
clear;
% a = elementary particle, m = meson, b = baryon
chosenSpecies = "b";
lightOnly = true; % If true, restricts to particles with M < 3700 GeV
allSpecies = ["a";"a";"b";"b";"a";"a";"m";"m";"b";"m";...
         "b";"b";"b";"b";"a";"b";"b";"m";"m";...
         "b";"a";"m";"b";"a";"m";"a";"a";"m";"m";...
         "b";"b";"a";"m";"m";"m";"b";"a";"a";"m";...
         "b";"a";"a";"b";"b";"b";"m";"a";"b";"b"];
allParticles = ["\gamma";"e^-";"p^+";"n";"e^+";"\mu";"\pi^0";"K";"\Lambda";"\pi^\pm";...
...
years = [1895 1897 1919 1932 1932 1937 1947 1947 1950 1950 ...
...
masses = [   0  0.5  938  940  0.5  106  135  496 1116  140 ...
...
for j=1:length(years)
    species = allSpecies(j);
    if species == chosenSpecies
        plot(years(j),masses(j),'ok','MarkerSize',30,'MarkerFaceColor','y');
        text(years(j)-2.2,masses(j),allParticles(j),'FontSize',15);
%        plot(years(j),masses(j),'.k','MarkerSize',20);
%        text(years(j) + 1,masses(j),allParticles(j),'FontSize',15);
    end
end
set(gca,'FontSize',15);
%xlim([1937 2020]);
